...
_CSV_COLUMNS = [
    'years_trading', 'years_customer', 'turn_over', 'bop',
    'credit rating', 'employess', 'corporate_family', 'country',
    'market', 'ABC', 'Anuual_spend', 'Budget_Spend', 'Make_Budget'
]
...
parser.add_argument(
    '--train_data', type=str, default=(r"c:\\_dev\\models\\official\\wide_deep_customer\\data\\customer.data"),
    help='Path to the training data.')

parser.add_argument(
    '--test_data', type=str, default=(r"c:\\_dev\\models\\official\\wide_deep\\data\\customer.test"),
...
def main(unused_argv):
  ...
  servable_model_dir = (r"c:\\_dev\\models\\official\\wide_deep\\")
